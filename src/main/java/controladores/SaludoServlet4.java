...
public class SaludoServlet4 extends HttpServlet {
...
//        PrintWriter out = response.getWriter();
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SaludoServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html");
        out.println("<html>");
        out.println("<title>Cuarto Servlet</title>");
        out.println("<body>");
        out.println("<h3>Hola, su Nombre es " + txtNombre + " y su Apellido es " + txtApellido + "</h3>");
        out.println("</body>");
        out.println("</html>");
        //processRequest(request, response);
    }
